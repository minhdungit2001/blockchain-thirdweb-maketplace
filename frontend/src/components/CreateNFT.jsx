...
export default function CreateNFT() {
  const { mintNFT, modal, setGlobalState, setAlert } = useStateContext();
  ...
  const handleSubmit = async (e) => {
    ...
    if (!price) {
      setAlert("Please enter a price!!!", "red");
      return;
    }
    if (!fileUrl) {
      setAlert("Please import a image!!!", "red");
      return;
    }
    await mintNFT({ title, price, description, fileUrl });
    resetForm();
  };
        ...
        <form className="flex flex-col">
          ...
          <button
            ...
            className="flex flex-row justify-center items-center
              ...
              focus:outline-none focus:ring mt-5 p-2"
          >
            Mint Now
          </button>
        </form>
